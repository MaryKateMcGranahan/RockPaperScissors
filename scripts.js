...
document.getElementById("enter_name_button").addEventListener("click",function(){
  ...
  if(!p_name){
    document.getElementById("bad_feedback").innerHTML= "No name entered! Enter a name";
    showOrNot(document.getElementById("bad_feedback"),true);
  }
  else{
  localStorage.setItem("player_name",p_name);
  document.getElementById("good_feedback").innerHTML= "Name successfully entered, get ready to play!";
  showOrNot(document.getElementById("good_feedback"),true);
  console.log(p_name);
  updateNames(p_name);
...
document.getElementById("throw_choice_button").addEventListener("click",function(){
  ...
  if(p_move=="blank"){
    document.getElementById("bad_feedback").innerHTML= "No throw chosen! Pick your move!";
    showOrNot(document.getElementById("bad_feedback"),true);
  }
  else{
